...
EntrenadorModule = __decorate([
    common_1.Module({
        imports: [],
        controllers: [entrenador_controller_1.EntrenadorController],
        providers: [entrenador_service_1.EntrenadorService],
        exports: [entrenador_service_1.EntrenadorService]
    })
], EntrenadorModule);
